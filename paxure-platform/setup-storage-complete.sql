-- Complete Storage Setup voor Paxure Platform
-- Voer dit uit NADAT de 'docs' bucket is aangemaakt in Supabase Dashboard
-- 
-- STAP: Ga eerst naar Storage → New bucket → Naam: 'docs' → Public: UIT → Create
-- Daarna voer je dit script uit
