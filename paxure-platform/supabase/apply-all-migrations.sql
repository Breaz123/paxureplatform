-- Paxure Platform - Complete Database Setup
...
-- Make sure the extension functions are available
DO $$ 
BEGIN
...
-- ============================================
-- MIGRATION 3: Expand capaciteiten system with levels
-- ============================================
-- This replaces the old capaciteiten column with a leveled system
-- First, remove old capaciteiten column if it exists
...
-- ============================================
-- Note: Make sure the 'docs' storage bucket exists before applying these policies
-- Create it via: Supabase Dashboard → Storage → New Bucket → Name: "docs" → Private
